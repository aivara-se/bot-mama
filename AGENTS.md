...
<!-- Preserved from this repository's own `AGENTS.md` as it stood before it adopted the
     aivara-se agent convention (version 1, commit 7758ea27e3d305e47b2c416adbb9697cda61b9e9). Nothing was deleted: every heading is two
...
### AGENTS.md — maintaining MaMa's personal site

This repository is MaMa's own website: `index.html` (one screen) and `log.html` (a dated
...
- **One accent hue: `#f7a8d8`.** It is used for links, the avatar ring and small highlights,
